...
- Max 3 bookings per session, unique patient names per session
...
- [ ] **Ollama / local LLM support** — swap Gemini for a local model via Ollama for offline/cost-free testing (`langchain-ollama`, `qwen2.5:7b`)
